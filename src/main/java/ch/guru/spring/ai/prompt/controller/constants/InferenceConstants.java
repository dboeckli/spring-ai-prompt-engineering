...
public final class  InferenceConstants {
    ...
    public final static String REVIEW_4 = """
    ...
    public final static String REVIEW_5 = """
    ...
    public final static String REVIEW_6 = """
    ...
    public final static String PROMPT_EMOTION = """
        ...
        Use the following format for your response, replacing __emotions__ with the actual emotions and __summary__ with the actual summary:
        Review 1: __emotions__
        Summary: __summary__
        Review 2: __emotions__
        Summary: __summary__
        Review n: __emotions__
        Summary: __summary__
